...
alarm_metadata = Table(
    'alarm_metadata', meta,
    Column('alarm_id', String(255), primary_key=True, index=True),
    Column('name', String(255), primary_key=True, index=True),
    Column('value', String(255), primary_key=True, index=True)
)
...
tables = [alarm, alarm_metadata, aggregated_metric, user, project]
